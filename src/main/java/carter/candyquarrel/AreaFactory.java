...
public class AreaFactory {
    ...
    public ArrayList<Area> makeNewAreas(){
        ...
        Area candycastle = new Area(new Area.AreaBuilder("Candy Castle")
                .setEnemy(new Enemy("Jamal", new Note("The Princess", "The Princess..?"), 125, 8,1000,1000)));
